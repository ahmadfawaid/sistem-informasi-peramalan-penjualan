            ...
            <div class="row">
                <div class="col col-11">
                    <div class="card custom">
                        <span class="title" style="margin-bottom: 20px;display: block;">Pembelian Baru {{ pembelian.nomor_faktur }}</span>
                        <div class="row">
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th v-if="pembelian.detail_pembelian.length > 1" style="width: 30px"></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="(item, index) in pembelian.detail_pembelian" :key="index">
                                    ...
                                    <td v-if="pembelian.detail_pembelian.length > 1"><a @click.prevent="removeLine(index)" href=""><i class="icon-hapus error" title="hapus"></i></a></td>
                                </tr>
                            </tbody>
                        </table>
                        <div class="footer">
                            <div class="left">
                                ...
                                <button class="button" type="submit" @click="openModal('add')"><i class="icon-sukses"></i>Simpan</button>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.$store.commit('pembelian_store/emptyPembelian', $('meta[name="user-id"]').attr('content'))
            this.$store.commit('pembelian_store/init')
        },
        methods: {
            openModal(modal) {
            ...
            removeLine(index) {
                if(this.pembelian.detail_pembelian.length > 1) {
