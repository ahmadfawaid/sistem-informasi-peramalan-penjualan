            ...
            <div class="modal-content">
                <form @submit.prevent="store()">
                    <div class="modal-header">
                        <span class="modal-title">Tambah Persediaan {{ nomorRak }}</span>
...
<script>
    ...
    export default {
        ...
        methods: {
            store() {
				this.$store.dispatch('persediaan_store/store', {persediaan: this.persediaan, perPage: this.perPage, nomorRak: this.nomorRak})
            },
            checkForm(form) {
